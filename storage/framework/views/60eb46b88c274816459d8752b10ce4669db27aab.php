<?php $__env->startSection('content'); ?>
    <section>
                ...
                <div class="card card-xxl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted mt-1 fw-bold fs-7"><?php echo e(\App\Models\User::count()); ?> users</span>
                        </h3>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="<?php echo e(asset('https://ui-avatars.com/api/length=2&background=random&name=' . $user->name)); ?>" alt="" loading="lazy" />
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#" class="text-dark fw-bolder text-hover-primary fs-6"><?php echo e($user->name); ?></a>
                                                    <span class="text-muted fw-bold text-muted d-block fs-7">HTML, JS, ReactJS</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block fs-6"><?php echo e($user->email); ?></a>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php echo e($user->role->title ?? "Haven't any Roles"); ?>
                                        ...
                                        <td class="text-end">
                                            <div class="d-flex flex-column w-100 me-2">
                                                <div class="d-flex flex-stack mb-2">
                                                    <span class="text-muted me-2 fs-7 fw-bold"><?php echo e(\Carbon\Carbon::parse($user->last_seen)->diffForHumans()); ?></span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-end">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user_show')): ?>
                                                ...
                                                <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_create_account<?php echo e($user->id); ?>" id="kt_toolbar_create_button">
                                            ...
                                            <a href="<?php echo e(route('users.edit', $user->id)); ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user_delete')): ?>
                                                    <form style="float: right" action="<?php echo e(route('users.destroy', $user->id)); ?>" method="post">
                                                        <?php echo csrf_field(); ?>
        ...
        <!--begin::Modal - Create account-->
            <div class="modal fade" id="kt_modal_create_account<?php echo e($user->id); ?>" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
                <div class="modal-dialog mw-1000px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <!--begin::Title-->
                            <h2 class="mb-0">Show user: <?php echo e($user->name); ?></h2>
                            <!--end::Title-->
                            <!--begin::Close-->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\permissiongate\resources\views/admin/users/index.blade.php ENDPATH**/ ?>