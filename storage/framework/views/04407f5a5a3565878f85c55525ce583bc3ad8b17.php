...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="<?php echo e(route('home-locale')); ?>">
            <img alt="Logo" src="<?php echo e(asset('demo1/dist/assets/media/logos/zmfood-logo.png')); ?>" class="h-45px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    <a class="<?php echo e(Request::is('admin') ? 'active' : ''); ?> menu-link" href="<?php echo e(route('admin')); ?>">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
											<span class="menu-link">
                                                ...
                                                <a href="<?php echo e(url('/')); ?>"><span class="menu-title">Home</span></a>
											</span>
                    </div>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
											<span class="menu-link">
                                                ...
                                                <a href="<?php echo e(route('production.index.page')); ?>"><span class="menu-title">Production</span></a>
											</span>
                    </div>
                </div>
                <div class="menu-item">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a <?php echo e(Request::is('admin/users') ? 'active' : ''); ?> class="menu-link  <?php if(request()->is('admin/users') || request()->is('admin/users/*')): ?> active <?php endif; ?>" href="<?php echo e(route('users.index')); ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if(request()->is('admin/roles') || request()->is('admin/roles/*')): ?> active <?php endif; ?>" href="<?php echo e(route('roles.index')); ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link <?php if(request()->is('admin/permissions') || request()->is('admin/permissions/*')): ?> active <?php endif; ?>" href="<?php echo e(route('permissions.index')); ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('categories_access')): ?>

                    <div class="menu-item">
                        <a class="menu-link <?php if(request()->is('admin/categories') || request()->is('admin/categories/*')): ?> active <?php endif; ?>" href="<?php echo e(route('categories.index')); ?>">
                                <span class="menu-icon">
											<!--begin::Svg Icon | path: icons/stockholm/Design/PenAndRuller.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('subcategories_access')): ?>
                <div class="menu-item menu-accordion">
                    <a class="menu-link <?php if(request()->is('admin/subcategories') || request()->is('admin/subcategories/*')): ?> active <?php endif; ?>" href="<?php echo e(route('subcategories.index')); ?>">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/stockholm/Shopping/Box2.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('products_access')): ?>
                <div class="menu-item menu-accordion">
									<a class="menu-link <?php if(request()->is('admin/products') || request()->is('admin/products/*')): ?> active <?php endif; ?>"  href="<?php echo e(route('products.index')); ?>">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/stockholm/Shopping/Box2.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="documentation/base/utilities.html">
                        ...
                        <span class="menu-title">Website Statistics</span>
                    </a>
                </div>
            </div>
            <!--end::Menu-->
...
<!--end::Aside-->
<?php /**PATH D:\laragon\www\permissiongate\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>