...
<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="<?php echo e(route('home-locale')); ?>" class="d-lg-none">
                <img alt="Logo" src="<?php echo e(asset('demo1/dist/assets/media/logos/zmfood-logo.png')); ?>" class="h-35px" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
                    ...
                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                        <div class="menu-item me-lg-1">
                            <a class="menu-link active py-3" href="index.blade.php">
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/basic/sign-in.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/basic/sign-up.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/basic/two-steps.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/basic/password-reset.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/basic/new-password.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/aside/sign-in.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                        <span class="menu-title">Sign-in</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/aside/sign-up.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                        <span class="menu-title">Sign-up</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/aside/two-steps.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                        <span class="menu-title">Two-steps</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/aside/password-reset.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                        <span class="menu-title">Password Reset</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/aside/new-password.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                        <span class="menu-title">New Password</span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/dark/sign-in.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                        <span class="menu-title">Sign-in</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/dark/sign-up.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                        <span class="menu-title">Sign-up</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/dark/two-steps.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                        <span class="menu-title">Two-steps</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/dark/password-reset.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                        <span class="menu-title">Password Reset</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/flows/dark/new-password.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                        <span class="menu-title">New Password</span>
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/extended/coming-soon.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/general/welcome.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/general/verify-email.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/general/password-confirmation.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/general/deactivation.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/general/error-404.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/authentication/general/error-500.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link py-3" href="../../../../public/demo1/dist/modals/forms/new-card.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
                                ...
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div class="menu-item">
                                            <a class="menu-link py-3" href="../../../../public/demo1/dist/widgets/lists.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3" href="../../../../public/demo1/dist/widgets/statistics.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3" href="../../../../public/demo1/dist/widgets/charts.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link py-3" href="../../../../public/demo1/dist/widgets/tables.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                                        ...
                                        <div class="scroll-y mh-200px mh-lg-325px">
                                            ...
                                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                ...
                                                <div class="symbol symbol-40px me-4">
                                                    <img src="../../../../public/demo1/dist/assets/media/avatars/150-1.jpg" alt="" />
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                            ...
                                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-40px me-4">
                                                    <img src="../../../../public/demo1/dist/assets/media/avatars/150-3.jpg" alt="" />
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column justify-content-start fw-bold">
                                            ...
                                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-40px me-4">
                                                    <img src="../../../../public/demo1/dist/assets/media/avatars/150-8.jpg" alt="" />
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column justify-content-start fw-bold">
                                            ...
                                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-40px me-4">
                                                    <img src="../../../../public/demo1/dist/assets/media/avatars/150-11.jpg" alt="" />
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column justify-content-start fw-bold">
                                            ...
                                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                <!--begin::Symbol-->
                                                <div class="symbol symbol-40px me-4">
                                                    <img src="../../../../public/demo1/dist/assets/media/avatars/150-12.jpg" alt="" />
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column justify-content-start fw-bold">
                                            ...
                                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                ...
                                                <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px" src="../../../../public/demo1/dist/assets/media/svg/misc/volicity-9.svg" alt="" />
																		</span>
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                            ...
                                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                ...
                                                <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px" src="../../../../public/demo1/dist/assets/media/svg/misc/tvit.svg" alt="" />
																		</span>
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                            ...
                                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                ...
                                                <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px" src="../../../../public/demo1/dist/assets/media/svg/misc/infography.svg" alt="" />
																		</span>
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                            ...
                                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                ...
                                                <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px" src="../../../../public/demo1/dist/assets/media/svg/misc/leaf.svg" alt="" />
																		</span>
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                            ...
                                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                ...
                                                <div class="symbol symbol-40px me-4">
																		<span class="symbol-label bg-light">
																			<img class="w-20px h-20px" src="../../../../public/demo1/dist/assets/media/svg/misc/tower.svg" alt="" />
																		</span>
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                                    ...
                                    <div class="d-flex flex-column px-9">
                                        ...
                                        <!--end::Section-->
                                        <!--begin::Illustration-->
                                        <img class="mh-200px" alt="metronic" src="../../../../public/demo1/dist/assets/media/svg/illustrations/work.svg" />
                                        <!--end::Illustration-->
                                    </div>
                                    <!--end::Wrapper-->
                                </div>
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                            <img src="<?php echo e(asset('https://ui-avatars.com/api/length=2&background=random&name=' . Auth::user()->name)); ?>" alt="" loading="lazy" />
                        </div>
                        <!--begin::Menu-->
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="<?php echo e(asset('https://ui-avatars.com/api/length=2&background=random&name=' . Auth::user()->name)); ?>" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                                        <div class="fw-bolder d-flex align-items-center fs-5"><?php echo e(Auth::user()->name); ?>
                                            ...
                                            <span class="badge badge-light-danger fw-bolder fs-8 px-2 py-1 ms-2">
                                                <?php echo e(Auth::user()->role->title ?? "--"); ?>
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start" data-kt-menu-flip="center, top">
                                <a href="#" class="menu-link px-5">
														...
														<img class="w-15px h-15px rounded-1 ms-2" src="../../../../public/demo1/dist/assets/media/flags/united-states.svg" alt="metronic" /></span></span>
                                </a>
                                <!--begin::Menu sub-->
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="account/settings.html" class="menu-link d-flex px-5 active">
															<span class="symbol symbol-20px me-4">
																<img class="rounded-1" src="../../../../public/demo1/dist/assets/media/flags/united-states.svg" alt="metronic" />
															</span>English</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="account/settings.html" class="menu-link d-flex px-5">
															<span class="symbol symbol-20px me-4">
																<img class="rounded-1" src="../../../../public/demo1/dist/assets/media/flags/spain.svg" alt="metronic" />
															</span>Spanish</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="account/settings.html" class="menu-link d-flex px-5">
															<span class="symbol symbol-20px me-4">
																<img class="rounded-1" src="../../../../public/demo1/dist/assets/media/flags/germany.svg" alt="metronic" />
															</span>German</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="account/settings.html" class="menu-link d-flex px-5">
															<span class="symbol symbol-20px me-4">
																<img class="rounded-1" src="../../../../public/demo1/dist/assets/media/flags/japan.svg" alt="metronic" />
															</span>Japanese</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="account/settings.html" class="menu-link d-flex px-5">
															<span class="symbol symbol-20px me-4">
																<img class="rounded-1" src="../../../../public/demo1/dist/assets/media/flags/france.svg" alt="metronic" />
															</span>French</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                            ...
                            <div class="menu-item px-5">
                                <a class="menu-link px-5" href="<?php echo e(route('logout')); ?>">Sign Out</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::Menu-->
...
<!--end::Header-->
<?php /**PATH D:\laragon\www\permissiongate\resources\views/admin/includes/header.blade.php ENDPATH**/ ?>