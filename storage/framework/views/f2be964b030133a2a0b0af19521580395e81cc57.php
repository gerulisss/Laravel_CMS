            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    <?php if(auth()->guard()->check()): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('articles.index')); ?>"><?php echo e(__('Articles')); ?></a>
                        </li>
...
<?php /**PATH D:\laragon\www\permissiongate\resources\views/layouts/mainapp.blade.php ENDPATH**/ ?>