<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header"><?php echo e(__('Add New Role')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="short_code" type="text" class="form-control <?php $__errorArgs = ['short_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="short_code" value="<?php echo e(old('short_code')); ?>" autocomplete="short_code" >
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\permissiongate\resources\views/admin/roles/create.blade.php ENDPATH**/ ?>