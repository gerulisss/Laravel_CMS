                ...
                <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center me-3">
                        ...
                        <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-4 lh-1">Dashboard
                            ...
                            <!--end::Separator-->
                            {{ \Carbon\Carbon::now()->setTimezone('Europe/Vilnius')->translatedFormat('Y-m-d H:i:s') }}
                        </h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Page title-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-dark hoverable card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-inverse-dark fw-bolder fs-2 mb-2 mt-5">{{ \App\Models\Role::count() }}</div>
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-warning hoverable card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-inverse-warning fw-bolder fs-2 mb-2 mt-5">{{ \App\Models\User::count() }}</div>
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-inverse-info fw-bolder fs-2 mb-2 mt-5">{{ \App\Models\Category::count() }}</div>
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-inverse-info fw-bolder fs-2 mb-2 mt-5">{{ \App\Models\Subcategory::count() }}</div>
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-inverse-info fw-bolder fs-2 mb-2 mt-5">{{ \App\Models\Product::count() }}</div>
