...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        <a href="{{route('home-locale')}}">
            <img alt="Logo" src="{{ asset('demo1/dist/assets/media/logos/zmfood-logo.png') }}" class="h-45px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
...
{{--                @role('super-admin')--}}
                <div class="menu-item">
                    <a class="{{ Request::is('admin') ? 'active' : '' }} menu-link" href="{{ route('admin')}}">
...
{{--                        @else--}}
{{--                            <span class="menu-title">Nerodyti dashboard</span>--}}
{{--                        @endif--}}
                    </a>
                </div>
{{--                @elserole('admin')--}}
...
{{--                @endrole--}}
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
											<span class="menu-link">
                                                ...
                                                <a href="{{route('production.index.page')}}"><span class="menu-title">Production</span></a>
											</span>
                    </div>
                </div>
                <div class="menu-item">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        @can('users_access')
                        <div class="menu-item">
                            <a {{ Request::is('admin/users') ? 'active' : '' }} class="menu-link  @if(request()->is('admin/users') || request()->is('admin/users/*')) active @endif" href="{{route('users.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                        ...
                        @endcan
                            @can('roles_access')
                        <div class="menu-item">
                            <a class="menu-link @if(request()->is('admin/roles') || request()->is('admin/roles/*')) active @endif" href="{{route('roles.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link @if(request()->is('admin/permissions') || request()->is('admin/permissions/*')) active @endif" href="{{route('permissions.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
...
{{--                @can('role_show')--}}
                    <div class="menu-item">
                        <a class="menu-link @if(request()->is('admin/categories') || request()->is('admin/categories/*')) active @endif" href="{{ route('categories.index')}}">
                                <span class="menu-icon">
											<!--begin::Svg Icon | path: icons/stockholm/Design/PenAndRuller.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                @endcan
                @can('subcategories_access')
                <div class="menu-item menu-accordion">
                    <a class="menu-link @if(request()->is('admin/subcategories') || request()->is('admin/subcategories/*')) active @endif" href="{{ route('subcategories.index')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/stockholm/Shopping/Box2.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                @can('products_access')
                <div class="menu-item menu-accordion">
									<a class="menu-link @if(request()->is('admin/products') || request()->is('admin/products/*')) active @endif"  href="{{ route('products.index')}}">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/stockholm/Shopping/Box2.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
